...
This .NET web app lets users enter text, select a target language, and add optional inputs. After clicking ‘Translate’, it uses the Azure AI Translator API (2025-05-01-preview) to return the translated text, charges, and response time on the UI.
